...
<div <?php post_class("post-box entry-content"); ?>>
    ...
    <div class="post-box-more">
    	<a href="<?php the_permalink(); ?>" title="<?php the_title();?>"><?php _e( 'Read More...', 'great' ); ?> <i class="fa fa-arrow-right"></i></a>
    </div>
    <div class="clear"></div>
</div><!-- #post-box -->
...
function great_wp_footer () { ?>
	...
	<footer id="colophon" class="site-footer" role="contentinfo">
        ...
        <div class="site-info"><?php printf( __( 'Copyright &copy; %1$d %2$s.','great' ),date('Y'),'<a href="' . esc_url( home_url( '/' ) ) . '" title="' . esc_attr( get_bloginfo( 'name', 'display' ) ) . '" ><span>' . get_bloginfo( 'name', 'display' ) . '</span></a>');?> <?php _e( 'Powered by WordPress', 'great' ); ?><span class="sep"> &amp; </span><?php printf(__('Author: %s', 'great' ), 'Ben Alvele, <strong><a target="_self" href="http://alvele.com/">alvele.com</a></strong>' ); ?><span class="sep"> &amp; </span><?php printf( __( '<span>Active theme</span> %s', 'great' ), 'Great' ); ?>
		</div><!-- .site-info -->
	</footer><!-- #colophon -->
