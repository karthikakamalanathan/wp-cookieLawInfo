...
$great_slider_array = array(
                            'enable_slider' => array(
                                'type' => 'checkbox',
                                'label' => __('Enable this section', 'great'),
                                'default' => 1,
...
$great_social_array = array(
                            'enable_sm_header' => array(
                                'type' => 'checkbox',
                                'label' => __('Add social media icons in Header', 'great'),
                                'default' => 0,
                                'sanitize_callback' => 'great_boolean',
                            ),
							'enable_sm_footer' => array(
                                'type' => 'checkbox',
                                'label' => __('Add social media icons in Footer', 'great'),
                                'default' => 0,
                                'sanitize_callback' => 'great_boolean',
                            ),
							'sm_icon_size' => array(
					...
					'style' => array(
                        ...
                        'fields' => array(
							...
							'posts_font_size' => array(
                                ...
                                'default' => '14',
								'choices' => array( '9'=>'9px','10'=>'10px','11'=>'11px','12'=>'12px','13'=>'13px','14'=>'14px','15'=>'15px','16'=>'16px','17'=>'17px','18'=>'18px','19'=>'19px','20'=>'20px','21'=>'21px','26'=>'26px','36'=>'36px', ),
                                'sanitize_callback' => 'absint',
                            ),
